...
public class AccountController : Controller
{
    ...
    [Route("Login")]
    [AllowAnonymous]
    public async Task<ViewResult> Login(Uri? returnUrl = null)
    {
        try
        {
    ...
    public Task<IActionResult> Register(RegisterViewModel registerViewModel)
    {
        ...
        if (this.ModelState.IsValid)
        {
            return this.RegisterInternal(registerViewModel);
        }

        AccountLog.LogInvalidModelState(this.logger);
        return Task.FromResult<IActionResult>(this.View(registerViewModel));
    }
    ...
    private async Task<IActionResult> RegisterInternal(RegisterViewModel registerViewModel)
    {
        try
        {
            // Sign out any existing sessions
